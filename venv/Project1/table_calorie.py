...
for category_name, category_href in all_categories.items():
    ...
    # Page check for the availability of a table with products
    alert_block = soup.find(class_="uk-alert-danger")
    if alert_block is not None:
        continue

    # Collect the tables of the table
    ...
    # We collect products of products
    ...
    count += 1
    print(f"# Iteration {count}. {category_name} recorded by...")
